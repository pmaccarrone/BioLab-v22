...
const BioLab = {
    ...
    showGuideModal() {
        ...
        const guides = [
            { file: 'biolab_tutorial.pdf', title: 'Tutorial BioLab',
              desc: 'Guida passo-passo al configuratore: come comporre una formula, leggere le proprietà, salvare e stampare. Ideale per iniziare.',
              icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#1565C0" stroke-width="1.5"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z"/><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z"/></svg>',
              tag: 'Inizia qui' },
